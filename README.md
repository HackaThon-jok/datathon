...
> **Runnable analytics delivery:** [Local migration and Athena handoff (Chinese)](docs/ANALYTICS_HANDOFF_CN.md), [source-to-target mapping](docs/SOURCE_TO_TARGET.md), and [AI conversion record](docs/AI_CONVERSION_LOG.md). The January single-store fixture is locally validated; region mapping and live Athena validation remain pending.
