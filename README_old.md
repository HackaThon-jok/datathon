...
[English](README.md) · [简体中文](README_CN.md) · [KPI contract](doc/KPI_CONTRACT.md) · [Minimum Kanban](KANBAN.md) · [Interactive architecture diagram](doc/aws-python-architecture.html)
