...
See [the handoff](../../docs/ANALYTICS_HANDOFF.md) for command order and required cloud evidence. Never use the published view name for a candidate. Do not publish unless the local run passed, Athena returned `failures = 0`, and a reviewer approved the exact run.
